      ...
      <div class="card">
          <h5 class="card-header">All Permission</h5>        
            <div class="dropdown" style=" display: flex; justify-content: flex-end;">
                <a class="btn btn-primary" style="margin: 10px; color:white;" data-bs-toggle="modal" data-bs-target="#large-modal">Add Permission</a>
            ...
            <table class="table table-striped">
              ...
              <tr>
                  ...
                  @foreach($percategory as $cat)
                    @if($per->permissioncategory_id == $cat->id)
                    <td><span class="badge bg-label-info me-1">{{ $cat->name}}</span></td>
                    @endif
                  @endforeach
                  <td>{{ $per->name }}</td>
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu">
                        <button class="dropdown-item" data-bs-toggle="modal" data-bs-target="#edit-modal" onclick="edit('{{$per->id}}','{{$per->name}}','{{$per->permissioncategory_id}}')"><i class="bx bx-edit-alt me-1"></i> Edit</button>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel3">Add Permission</h5>
            <button
              type="button"
              class="btn-close"
